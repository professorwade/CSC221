...
def draw_section_outlines():
    ...
    arcade.draw_rectangle_outline(150, 150, 300, 300, arcade.color.RED,3)
...
def draw_section_1():
    arcade.draw_rectangle_outline(150, 150, 100, 100, arcade.color.RED)
    for column in range(10):
        for row in range(10):
            ...
            if column % 2 == 0:
                ...
                arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.RADICAL_RED)
