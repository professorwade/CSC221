"""
So far our code has been a topdown process where we import arcade, define any necessary
constants, and write the code that we want to run. While this works, it isn't really the
 best way to accomplish more complex goals. To do this, we want to break out code up in
